...
let tempX=Math.floor(Math.random()*1280);
        ...
        bird.push({hp:ememyHp,x:tempX,y:0,w:85,h:42,oddEven:0,ratio:(640-tempX)/403,draw: function () {
    ...
    if(count++%2>=1){
     worm.push({hp:ememyHp,leftSide:true, x:0,y:555,w:63,h:23,oddEven:0,draw: function () {
             if((this.oddEven++)%20>=10){
    ...
    worm.push({hp:ememyHp,leftSide:false, x:1280,y:555,w:63,h:23,oddEven:0,draw: function(){
             if(this.oddEven++%20>=10){
